...
export const metadata: Metadata = {
  ...
  description: "4ª y 5ª gama para hostelería: platos preparados de autor e ingredientes diferenciales que ahorran tiempo sin renunciar al criterio.",
  alternates: {
    canonical: "/es/secrets-du-xef",
    languages: {
